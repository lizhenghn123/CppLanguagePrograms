...
namespace MyGame
{
    namespace Example
    {
        ...
        inline const char *EnumNameColor(int e)
        {
            return EnumNamesColor()[e];
        }
        ...
        inline const char *EnumNameAny(int e)
        {
            return EnumNamesAny()[e];
        }
...
public:
        ...
        struct Monster : private flatbuffers::Table
        {
            ...
            {
                return GetStruct<const Vec3 *>(4);
            }
            int16_t mana() const
            {
                return GetField<int16_t>(6, 150);
            }
            int16_t hp() const
            {
                return GetField<int16_t>(8, 100);
            }
            ...
            int8_t color() const
            {
                return GetField<int8_t>(16, 2);
            }
            uint8_t test_type() const
            {
                return GetField<uint8_t>(18, 0);
            }
            const void *test() const
            {
                return GetPointer<const void *>(20);
            }
            const flatbuffers::Vector<const Test *> *test4() const
            {
                return GetPointer<const flatbuffers::Vector<const Test *> *>(22);
            }
            const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *testarrayofstring() const
            {
                return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *>(24);
            }
            ...
            {
                return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Monster>> *>(26);
            }
            const Monster *enemy() const
            {
                return GetPointer<const Monster *>(28);
            }
        ...
        struct MonsterBuilder
        {
            ...
            {
                fbb_.AddStruct(4, pos);
            }
            void add_mana(int16_t mana)
            {
                fbb_.AddElement<int16_t>(6, mana, 150);
            }
            void add_hp(int16_t hp)
            {
                fbb_.AddElement<int16_t>(8, hp, 100);
            }
            ...
            {
                return flatbuffers::Offset<Monster>(fbb_.EndTable(start_, 13));
            }
        };
        ...
        bool VerifyAny(const flatbuffers::Verifier& verifier, const void *union_obj, uint8_t type)
        {
            ...
            case Any_NONE:
                return true;
            case Any_Monster:
                return verifier.VerifyTable(reinterpret_cast<const Monster *>(union_obj));
            default:
                return false;
            }
        }
        ...
        inline bool VerifyMonsterBuffer(const flatbuffers::Verifier& verifier)
        {
            return verifier.VerifyBuffer<Monster>();
        }
