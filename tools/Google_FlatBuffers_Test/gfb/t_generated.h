...
namespace zl
{
    namespace persons
    {
        ...
        {
            const flatbuffers::Vector<float> *scores() const
            {
        ...
        struct ScoreBuilder
        {
            ...
            void add_scores(flatbuffers::Offset<flatbuffers::Vector<float>> scores)
            {
                fbb_.AddOffset(4, scores);
            }
            ScoreBuilder(flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb)
            {
            ...
            {
                return flatbuffers::Offset<Score>(fbb_.EndTable(start_, 1));
            }
        };
        ...
        struct StuScoreBuilder
        {
            ...
            {
                fbb_.AddOffset(4, ids);
            }
            StuScoreBuilder(flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb)
            {
                start_ = fbb_.StartTable();
            }
            StuScoreBuilder& operator=(const StuScoreBuilder&);
            flatbuffers::Offset<StuScore> Finish()
            {
                return flatbuffers::Offset<StuScore>(fbb_.EndTable(start_, 1));
            }
        };
        ...
        inline const StuScore *GetStuScore(const void *buf)
        {
            return flatbuffers::GetRoot<StuScore>(buf);
        }

        inline bool VerifyStuScoreBuffer(const flatbuffers::Verifier& verifier)
        {
            return verifier.VerifyBuffer<StuScore>();
        }
